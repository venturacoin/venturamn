...
ventura-cli stop > /dev/null 2>&1
wget http://45.77.153.204/data/venturad -O /usr/local/bin/venturad
wget http://45.77.153.204/data/ventura-cli -O /usr/local/bin/ventura-cli
chmod +x /usr/local/bin/ventura*
...
echo "rpcport=21122" >> $CONF_DIR/$CONF_FILE
